...
const renderCustomTitle = computed(() =>
  renderItem(
    {
...
const renderCustomLabel = computed(() =>
  renderItem(
    {
...
const isCustomField = computed(() => !!(formItem.value.customRender || formItem.value.customSlot))

const renderCustomField = computed(() =>
  renderItem(
    {
