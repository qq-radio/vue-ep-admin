...
import type { DisplayType } from '@center/components/basic-display'
...
export interface TableSchema {
  ...
  customSlot?: string
  display?: DisplayType
  displayProps?: Recordable | ((params: TableCellCallbackParams) => Recordable)
  displaySlots?: Recordable | ((params: TableCellCallbackParams) => Recordable)
}
